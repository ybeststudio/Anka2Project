...
add_goto_info("dt", 0, 65, 5905, 1108)
...
add_goto_info("event", 0, 230, 9856, 7552)
...
add_goto_info("shadow_tower1", 0, 144, 16894, 22609)
add_goto_info("shadow_tower2", 0, 144, 17841, 22987)
add_goto_info("shadow_tower3", 0, 144, 17877, 23699)
add_goto_info("shadow_tower4", 0, 144, 16873, 23787)
add_goto_info("shadow_tower5", 0, 144, 17268, 23855)

add_goto_info("trade", 0, 231, 91933, 92426)
...
add_bgm_info(144, "shadow_dungeon.mp3", 0.5);
